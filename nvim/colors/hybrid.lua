...
-- Source: Ghostty terminal theme /usr/share/ghostty/themes/Hybrid
-- Structure mirrors sunset-drive.lua — only color tokens are changed
...
hl("DiagnosticUnderlineWarn",      { sp = c.br_yellow, undercurl = true })
...
hl("DiagnosticVirtualTextWarn",    { fg = c.br_yellow, bg = c.bg_alt })
...
hl("@comment.warning",       { fg = c.bg, bg = c.br_yellow, bold = true })
...
hl("DiffAdd",    { bg = "#1c2a1e" })
hl("DiffChange", { bg = "#2a2516" })
hl("DiffDelete", { bg = "#2a1a1b" })
hl("DiffText",   { bg = "#333020" })
...
-- Export color table for external use (e.g. lualine)
vim.g.hybrid_colors = c
